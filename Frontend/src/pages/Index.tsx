  ...
  const fileTypes = [
    {
      id: 'pdf',
      title: 'Upload PDF',
      description: 'Upload your insurance paperwork, policies, and claim forms in PDF.',
      icon: FileText,
    ...
    },
    {
      ...
      description: 'Upload your Word-based insurance documentation and reports.',
      icon: File,
    ...
    },
    {
      id: 'email',
      title: 'Analyze Email',
      description: 'Upload insurance-related email communications.',
      icon: Mail,
